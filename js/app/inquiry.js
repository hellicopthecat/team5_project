...
$('.qur_ok').click(()=>{
    ...
    let name02 = document.getElementById('qur_name_02').value;
    ...
    let phone4 = document.getElementById('qur_phone_04').value;
    let phone5 = document.getElementById('qur_phone_05').value;
    let phone6 = document.getElementById('qur_phone_06').value;
