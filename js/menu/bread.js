...
const switchToPicsView = () => {
  viewPics.style.background =
    "url(../../img/menu/icon-pics-wh.png) no-repeat left";
...
const switchToNutrisView = () => {
  viewPics.style.background =
    "url(../../img/menu/icon-pics.png) no-repeat left";
  viewPics.style.backgroundColor = "#fff";
  viewPics.style.color = "#555";

  viewNutris.style.background =
    "url(../../img/menu/icon-ntris-wh.png) no-repeat left";
...
$(".selector_tab").click(function () {
  ...
  if (arrowImage.includes("arrowD.png")) {
    $(".selector_tab a").css(
      "background-image",
      "url(../../img/icons/arrowU.png)"
    );
  } else {
    $(".selector_tab a").css(
      "background-image",
      "url(../../img/icons/arrowD.png)"
    );
  }
});
...
const otherCheckboxes = document.querySelectorAll(
  "#category_01, #category_02, #category_03, #category_04, #category_05"
);
